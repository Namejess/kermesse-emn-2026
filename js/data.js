...
const INDICES = {
  maternelle: [
    ...
    { num: 3, title: 'Indice 3', emoji: '🐝', shortDesc: 'Patientez...', fullDesc: 'Patientez pour recevoir ce nouvel indice !', duration: '', age: '' },
    { num: 4, title: 'Indice 4', emoji: '🎨', shortDesc: 'Patientez...', fullDesc: 'Patientez pour recevoir ce nouvel indice !', duration: '', age: '' },
    { num: 5, title: 'Indice 5', emoji: '', shortDesc: 'Patientez...', fullDesc: 'Patientez pour recevoir ce nouvel indice !', duration: '', age: '' },
    { num: 6, title: 'Indice 6', emoji: '🧺', shortDesc: 'Patientez...', fullDesc: 'Patientez pour recevoir ce nouvel indice !', duration: '', age: '' },
  ],
  primaire: [
